...
<div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center mb-3 gap-2">
    <h3 class="mb-0">Stock Availability Page</h3>
...
<table id="stocksTable" class="table table-bordered table-hover table-striped align-middle">
...
<!-- Your custom JS -->
<script src="<?= BASE_PATH ?>/public/js/stock.js"></script>
